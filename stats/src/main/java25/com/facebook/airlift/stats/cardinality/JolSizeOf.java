 ...
 * level: this class carries Java 25 class file version (major version 69), proving
 * that version-specific bytecode is correctly packaged and dispatched by the JVM at runtime.
 *
 * <p>Named {@code JolSizeOf} to avoid collision with {@code io.airlift.slice.SizeOf}.
 */
final class JolSizeOf
{
    ...
    static long instanceSize(Class<?> clazz)
    {
        ...
        // Class file version will be 69 (Java 25), confirming --release 25 compilation.
